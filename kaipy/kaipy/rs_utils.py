...
def make_conjunction(rs: ReachabilitySystem, l: Type.List[Kore.Pattern]) -> Kore.Pattern:
...
def cleanup_eqs(rs: ReachabilitySystem, main_part: Kore.Pattern, eqs: Type.Dict[Kore.EVar, Kore.Pattern]) -> Kore.Pattern:
